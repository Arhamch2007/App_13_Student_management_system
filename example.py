...
class AgeCalculator(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("AgeCalculator")
        grid = QGridLayout()

        # Create widgets
        name_labal = QLabel("Name:")
        self.name_line_edit = QLineEdit()

        date_birth_labal = QLabel("Date of birth MM/DD/YYYY:")
        ...
        # Add widgets to grid
        grid.addWidget(name_labal, 0, 0)
        grid.addWidget(self.name_line_edit, 0, 1)
        grid.addWidget(date_birth_labal, 1, 0)
